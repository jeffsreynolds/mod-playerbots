...
bool PlayerbotAIConfig::Initialize()
{
    ...
    randomBotAuctionHouse = sConfigMgr->GetOption<bool>("AiPlayerbot.RandomBotAuctionHouse", true);
    auctionVisitDelay = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionVisitDelay", 30 * MINUTE);
    auctionVisitMinInterval = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionVisitMinInterval", 15 * MINUTE);
    auctionVisitRetryDelay = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionVisitRetryDelay", 30 * MINUTE);
    auctionVisitLevelInterval = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionVisitLevelInterval", 2);
    ...
    logAuctionHouseActivity = sConfigMgr->GetOption<bool>("AiPlayerbot.LogAuctionHouseActivity", false);
    ...
    auctionBuyerEnabled = sConfigMgr->GetOption<bool>("AiPlayerbot.AuctionBuyerEnabled", false);
    buyUpgradeThreshold = sConfigMgr->GetOption<float>("AiPlayerbot.BuyUpgradeThreshold", 1.2f);
    auctionBuyPriceMinPercent = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyPriceMinPercent", 80);
    auctionBuyPriceMaxPercent = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyPriceMaxPercent", 120);
    auctionBuyItemsPerVisit = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyItemsPerVisit", 3);
    auctionBuyMaxSpendWhite = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyMaxSpendWhite", 0);
    auctionBuyMaxSpendGreen = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyMaxSpendGreen", 25);
    auctionBuyMaxSpendBlue = sConfigMgr->GetOption<uint32>("AiPlayerbot.AuctionBuyMaxSpendBlue", 50);
